...
$(function(){
    ...
    if (true) {
        ...
        //////////////////////////////////////华丽的分割//////////////////////////////////////////////////////////
        let house = new Menu(21, "house.html", "房源", "", "");
        let newHouse = new Menu(2, "", "新房", [house], "icon-layers");
        var m2 = JSON.parse(JSON.stringify(newHouse));

        //////////////////////////////////华丽的再次分割////////////////////////////////////////////////////////////
        let modular = new Menu(31, "modular.html", "功能模块", "", "");
        let base_area = new Menu(32, "base_area.html", "行政区域", "", "");
        let system = new Menu(3, "", "系统设置", [modular, base_area], "icon-settings");
        var m3 = JSON.parse(JSON.stringify(system));
        html += MenuHelper.node([m1, m2, m3]);
